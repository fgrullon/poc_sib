...
class AlphaVantageAPIClient:
    ...
    def _make_request(self, params: dict):
        ...
        time_since_last_last_call = current_time - self._last_call_time

        if time_since_last_last_call < self.CALL_INTERVAL_SECONDS:
            wait_time = self.CALL_INTERVAL_SECONDS - time_since_last_last_call
